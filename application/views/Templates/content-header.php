	...
	<div class="nav-right ">
		<div class="profile-dropdown">
			<a href="" id="openProfile" class="nav-item">
				<img src="<?php echo base_url('asset/user/foto_profile/'.$user['image']); ?>">
			</a>
			<div class="profile-dropdown-item">
				<h1><?php echo $user['nama']; ?></h1>
				<a href="<?= base_url('pengguna/edit_profil')?>" class="profile-btn">Profile</a>
		...
		<div class="profile-dropdown">
			<a href="" id="openProfile" class="nav-item">
				...
				<?php $notif = $this->db->get_where('pemberitahuan', ['ke' => $this->session->userdata('user_id')])->result_array(); ?>
